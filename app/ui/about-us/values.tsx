...
export default function Values(){
    ...
    return(
        <div className='container w-[88%] lg:w-full flex flex-col items-center mb-10 lg:m-auto' >
            <div className='shadow-lg shadow-gray-300 rounded-2xl px-3 lg:px-8 w-full py-10 lg:py-14 bg-gray-300'>
            ...
            <div className='py-10 lg:py-14 flex flex-col flex-wrap 2xl:flex-nowrap lg:flex-row lg:justify-center gap-10'>
                {
            ...
            <Link href={'/contact-us'} className="inline-flex items-center text-md lg:text-lg 2xl:text-xl font-semibold border-2 border-transparent bg-sky-900 text-gray-100 px-5 py-2 rounded-2xl mx-auto hover:bg-transparent hover:border-sky-900 hover:text-sky-900">Contact Us <ArrowRight className="ml-2"/></Link>
        </div>
    )
}