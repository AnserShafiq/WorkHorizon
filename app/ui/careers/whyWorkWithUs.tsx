...
export default function WhyWorkWithUs() {
    const [points, setPoints] = useState([
        ...
        { image:'/assets/careers-w-3.jpg',title: 'Training & Development', desc: 'We invest in your professional growth.', active: false },
        { image:'/assets/careers-w-4.jpg',title: 'Supportive Work Culture', desc: 'Be part of a collaborative and diverse team.', active: false },
        { image:'/assets/careers-three.jpg',title: 'Global Exposure', desc: 'Work on international campaigns and enhance your skills.', active: false }
    ]);
    ...
    return (
        <div className="w-full grid grid-cols-2 bg-special-blue my-10">
            <div className="container w-[70%] mr-0 pr-4 py-10 flex flex-col items-start justify-center">
                ...
                {points.map((point, index) => (
                    ...
                    >
                        <div 
                            className={`rounded-full h-3 w-3 border ${point.active ? 'bg-white' : 'border-white'} mr-2 mt-2`}
                        />
            ...
            <div>
                <Image 
                    className="h-[600] w-full object-center object-cover" 
