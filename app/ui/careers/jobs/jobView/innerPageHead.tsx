...
export default function InnerPageHead({activeSection, setActiveSection}: {activeSection: string, setActiveSection: Function}){

    return(
        <div className='container w-[88%] lg:w-[50%] flex flex-col items-center border-b border-gray-300'>
