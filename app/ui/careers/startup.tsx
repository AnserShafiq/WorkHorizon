        ...
        <div className="container w-[88%] lg:w-full shadow-lg shadow-gray-300 rounded-2xl my-10">
            <div className="flex flex-col relative items-center"> 
                ...
                <div className='absolute bottom-0 lg:bottom-[6%] w-full lg:w-[87%] h-auto flex flex-col backdrop-blur rounded-b-2xl lg:rounded-2xl py-6 lg:py-12 px-4 bg-transparent-one'>
                    ...
                    <p className="text-md lg:text-lg 2xl:text-xl capitalize font-normal text-gray-100 tracking-wide mb-3 lg:mb-5">{`At Work Horizon, we believe in fostering talent, innovation, and professional growth. Whether you are an experienced professional or just starting your career, we offer a dynamic and rewarding work environment where you can thrive.`}</p>
                    <Link href={'/careers'} className="text-md lg:text-lg 2xl:text-xl bg-sky-900 font-semibold px-4 py-2 w-fit mx-auto lg:mx-0 text-gray-100 rounded-xl transition-transform ease-in-out duration-300 hover:scale-[1.05]">Connect With Work Horizon</Link>
                </div>
            </div>
        </div>
    )
