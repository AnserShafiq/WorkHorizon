    ...
    return(
        <div className="my-28 overflow-hidden">
            ...
            <div className="flex flex-row xl:grid xl:grid-cols-[45%,55%] mt-5 w-full">
                ...
                <div className="pl-8 pr-3 flex flex-col justify-center" data-aos='fade-left' data-aos-duration='700'>
