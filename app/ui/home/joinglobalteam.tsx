...
export default function JoinGlobalTeam(){
    return(
        <div className="my-14 xl:my-28 overflow-x-hidden container w-[92%] xl:w-full">
            <div className="flex flex-col-reverse xl:grid xl:grid-cols-[55%,45%] my-5 w-full">
                <div className="xl:pr-8 xl:pl-2 flex flex-col relative justify-start pt-8 xl:pt-12" data-aos='fade-right' data-aos-duration='700'>
                ...
                <div className="xl:pl-5 xl:pr-3" data-aos='fade-left'>
                    <Image src={'/assets/h8.jpg'} alt="About - Work Horizon" className="rounded-xl object-cover object-center shadow-md shadow-transparent-one w-full h-[350px] xl:h-[500px]" width={500} height={500} />
                </div>
            </div>
        </div>
    )
