...
export default function JoinGlobalTeam(){
    return(
        <div className="my-28 overflow-x-hidden container">
            <div className="flex flex-row xl:grid xl:grid-cols-[55%,45%] my-5 w-full">
                ...
                <div className="pl-5 pr-3" data-aos='fade-left'>
                    <Image src={'/assets/h8.jpg'} alt="About - Work Horizon" className="rounded-xl object-cover object-center shadow-md shadow-transparent-one w-full h-[500px]" width={500} height={500} />
                </div>
            </div>
        </div>
    )
