...
export default function WhyChooseUs(){
    ...
    return(
        <div className="flex flex-col items-center my-8 lg:my-20 w-[92%] lg:w-full container">
            ...
            <div className=" mx-14 lg:mx-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 justify-center xl:gap-10" data-aos='fade-up'>
                {
                    points.map((item, index) => 
                        <div className="flex flex-col items-center border text-center py-10 rounded-2xl bg-dullWhite shadow-sm px-3" key={index} data-aos='lg:fade-up'>
