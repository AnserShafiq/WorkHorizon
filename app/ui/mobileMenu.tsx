        ...
        <>
            {!openMenu ? (
                ...
                <div className="w-full h-screen fixed top-0 left-0 z-40 bg-black/50">
                    ...
                    {/* Sidebar */}
                    <div className={`w-[88%] flex flex-col justify-around gap-5 h-screen bg-sidemenu-bg px-5 fixed top-0 left-0 transform transition-transform ease-in-out duration-[0.7s] ${openMenu ? 'translate-x-0':'-translate-x-full'} `}>
